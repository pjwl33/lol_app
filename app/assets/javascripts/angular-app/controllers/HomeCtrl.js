ang.controller('HomeCtrl', function($scope, $animate, $http, $interval){
  ...
  $scope.teamComps = [
  {name: "WOMBOLOGY", abbr: "wombo", p1Champs: ['Amumu', 'Sejuani'], p2Champs: ['Graves', 'Jinx'], p3Champs: ['Nautilus', 'Malphite', 'Lissandra'], p4Champs: ['Viktor', 'Vi', 'JarvanIV'], p5Champs: ['Thresh', 'Nami', 'Blitzcrank'], p6Champs: ['Annie', 'Kalista', 'Heimerdinger']},
